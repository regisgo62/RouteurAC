...
/*   // en courant continu 
   RAMesure.mesurePinceTension(700, 20); // mesure le courant et la tension avec 2 boucles de filtrage (700,20)
    int dev = RARegulation.mesureDerive(intensiteBatterie, 0.3); // donne 1 si ça dépasse l'encadrement haut et -1 si c'est en dessous de l'encadrement (Pince,0.2)
    puissanceGradateur = RARegulation.regulGrad(dev);
*/
 //   intensiteDC=RAMesure.mesurePinceAC(pinPinceAC,0.350,true); 
    intensiteDC=RAMesure.mesurePinceAC(pinPinceAC,routeur.coeffPince,true); 
